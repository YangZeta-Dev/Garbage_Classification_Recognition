package com.yaoliyun.web.controller.common;
...
public class CaptchaController
{
    ...
    private void setFont(Captcha captcha, String captchaType) throws IOException, FontFormatException {
        RuoYiConfig.CaptchaFontConfig fontConfig = RuoYiConfig.getCaptchaFont();

        // 如果配置为空，使用默认值
        if (fontConfig == null) {
            fontConfig = new RuoYiConfig.CaptchaFontConfig();
        }
