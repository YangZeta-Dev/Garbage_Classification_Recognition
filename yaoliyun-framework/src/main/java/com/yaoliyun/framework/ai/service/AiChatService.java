package com.yaoliyun.framework.ai.service;
...
import com.yaoliyun.framework.ai.domain.AiChatRequest;
import com.yaoliyun.framework.ai.domain.AiChatResponse;
import com.yaoliyun.framework.ai.domain.AiMessage;
import com.yaoliyun.framework.ai.util.AiResponseProcessor;
import com.yaoliyun.framework.config.AiConfig;
...
public class AiChatService
{
    ...
    private AiChatResponse sendSingleRequest(AiChatRequest request)
    {
        try {
            ...
            connection.setRequestProperty("User-Agent", "YaoLiYun-AI-Client/1.0");
