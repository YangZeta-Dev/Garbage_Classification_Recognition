<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="封面" align="center" prop="coverImage" width="80">
    ...
    <!-- 详情对话框 -->
    <el-dialog title="文章详情" :visible.sync="viewOpen" width="700px" append-to-body>
      <el-descriptions :column="2" border>
        <el-descriptions-item label="ID">{{ viewForm.articleId }}</el-descriptions-item>
        ...
        <el-descriptions-item label="封面" :span="2">
          <image-preview v-if="viewForm.coverImage" :src="viewForm.coverImage" :width="100" :height="100"/>
          <span v-else>-</span>
        </el-descriptions-item>
        <el-descriptions-item label="浏览量">{{ viewForm.viewCount }}</el-descriptions-item>
        ...
        <el-descriptions-item label="内容" :span="2">
          <div v-html="viewForm.content" style="max-height: 300px; overflow-y: auto;"></div>
        </el-descriptions-item>
      </el-descriptions>
      <div slot="footer" class="dialog-footer">
...
<script>
import { listArticle, getArticle, delArticle, addArticle, updateArticle, getCategoryIdOptions } from "@/api/system/article"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除垃圾分类知识文章编号为"' + articleIds + '"的数据项？').then(function() {
